...
class Blockchain(object):
    ...
    def generate_new_block(self, bpm=randint(53, 63), oldBlock='', address=''):
        ...
        index = len(self.blockChain) + 1 if not oldBlock else oldBlock['Index'] + 1
    ...
    def print_blocks(self):
        print("Printed Blocks:")
        n = len(self.blockChain) if len(self.blockChain) < 10 else 10
        for i in range(n):
...
def main():
    ...
    print("blockchain5 is created")
    blockchain5 = Blockchain(GENESIS_BLOCK5, account5)
    blockchain5.add_new_node(blockchain)
    blockchain5.add_new_node(blockchain2)
    blockchain5.add_new_node(blockchain3)
    blockchain5.add_new_node(blockchain4)
    blockchain5.pos()
    clients.append(blockchain5)
